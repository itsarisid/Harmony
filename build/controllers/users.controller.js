...
let UsersController = class UsersController extends tsoa_1.Controller {
    createUser(requestBody) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            new users_service_1.UsersService().create(requestBody);
            // Create token
            const token = jwt.sign(requestBody, _CONFIGS.JWT.secret, {
                expiresIn: _CONFIGS.JWT.expiresIn,
                audience: _CONFIGS.JWT.audience,
                subject: _CONFIGS.JWT.subject,
            });
            return new apiResponse_1.APIResponse(Object.assign(Object.assign({}, requestBody), { id: 1, token: token }));
        });
    }
};
__decorate([
